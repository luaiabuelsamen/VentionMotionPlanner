...
# Debugging
print(f"Constrained Grasp Approach: {args.constrain_grasp_approach}")
...
class UR5eMotionPlanner:
    def __init__(self, xml_path: str, robot_config_file: str, world_config_file: str, tensor_device: str = "cuda:0", constrain_grasp_approach: bool = False):
        np.set_printoptions(precision=2, suppress=True, linewidth=100)

        # added for constrain grasp angle
    ...
    def plan_motion(self, goal_position):
        ...
        plan_config = MotionGenPlanConfig(
            ...
            pose_cost_metric=PoseCostMetric.create_grasp_approach_metric(
                offset_position=0.1, tstep_fraction=0.8
            ) if self.constrain_grasp_approach else None
        )
