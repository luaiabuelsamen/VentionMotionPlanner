...
ros2 action send_goal /movel curobo_action/action/MoveL "{goal_pose: [0, -0.5, 0.2, 0.0, 0.0, -1.0, 0.0], mpc: false, constrained: false}"
ros2 action send_goal /movel curobo_action/action/MoveL "{goal_pose: [0.5, 0.5, 0.5, 0.0, 0.0, -1.0, 0.0], mpc: false, constrained: false}"
ros2 action send_goal /movel curobo_action/action/MoveL "{goal_pose: [0, -0.5, 0.2, 0.0, 0.0, -1.0, 0.0], mpc: false, constrained: false}"
ros2 action send_goal /movel curobo_action/action/MoveL "{goal_pose: [0.5, 0.5, 0.5, 0.0, 0.0, -1.0, 0.0], mpc: false, constrained: false}"
ros2 action send_goal /movel curobo_action/action/MoveL "{goal_pose: [0, -0.5, 0.2, 0.0, 0.0, -1.0, 0.0], mpc: false, constrained: false}"
ros2 action send_goal /movel curobo_action/action/MoveL "{goal_pose: [0.5, 0.5, 0.5, 0.0, 0.0, -1.0, 0.0], mpc: false, constrained: false}"
